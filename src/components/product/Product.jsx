...
function Product({ id, title, price, category, image }){
    ...
    return(
        <div className="w-96 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex-col shadow-lg shadow-indigo-500/50">
            <img className="m-auto mt-6 w-48 h-60 rounded-t-lg hover:cursor-pointer shadow-lg shadow-white-500/50" src={image} alt="" onClick={()=>navToProductPage(id)} />
        <div className="p-5">
            <a href="#">
                <h5 className="mt-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white h-24">{title}</h5>
            </a>
            ...
            <p className="mb-3 text-white">${price}</p>
